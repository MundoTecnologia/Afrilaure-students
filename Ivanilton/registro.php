...
<body>
    <section class="container">
        <header><h1 class="header">Cadastrar</h1></header>
        ...
        <input type="hidden" name="acao" value="cadastrar">
            ...
            <div class="input-box">
                ...
                <input type="text" maxlength="15"  pattern="\d{9}LA\d{3}" name="identidade"  placeholder="insira o numero do seu bilhete de identidade Formato: 123456789LA123" required />
                <!-- <small></small> -->
            </div>
            <div class="input-box">
            ...
            <div class="column">
                ...
                <div class="input-box">
                    ...
                    <input type="date" name="data_nasc" max="2024-06-01" required />
                </div>
